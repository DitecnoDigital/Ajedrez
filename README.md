...
Esta realizado bajo la plataforma linux. Entonces tener ciertas consideraciones en diferentes Sistemas Operativos. 
    ...
    Los encabezados de las clases Piece,Board,UI. Tienen extención .hpp 
    y el desarrollo de los metodos y contructores Piece, Board.... Tienen extención .cpp
...
### Tutorial de como usar g++ en la consola: 
 ...
 ### Para compilar desde la terminal escribí la siguiente linea:        
    ...
    g++ main.cpp Piece.cpp Board.cpp UI.cpp -lsfml-system -lsfml-window -lsfml-graphics -o Game
